...
<button class="navbar-toggler bg-body-tertiary" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="center">
        <main class="main-vale-presente">
            <h1>Cartao de 15% de desconto</h1>
            
            <img src="images/voucher15.png" alt="Cartão Vale Presente de 15% de Desconto" title="Voucher 15% de Desconto"  style="width: 50%; border-radius: 2rem;">
            
            <p>Após a confirmação, serão descontados<br> 500 pontos da sua conta</p>

            <form action="vouncher15.php" method="post"><input type="submit" value="Prosseguir" name="opcao1" class="prosseguir-vale-presente"></form>
        </main>
    </div>
